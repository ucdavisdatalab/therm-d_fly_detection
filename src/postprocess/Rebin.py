...
if apparatus_name == "shiny":
    #Ben
    lane1_df = cleaned_dataframe[(cleaned_dataframe['y_cm'] < 3)] 
    lane1_df.to_csv("Lane_1_predictions.csv", index=False)

    lane2_df = cleaned_dataframe.loc[(cleaned_dataframe['y_cm'] < 5.5) & (cleaned_dataframe['y_cm'] > 3)]
    ...
    lane5_df = cleaned_dataframe.loc[(cleaned_dataframe['y_cm'] < 13) & (cleaned_dataframe['y_cm'] > 10.5)]
    lane5_df.to_csv("Lane_5_predictions.csv", index=False)

    lane6_df = cleaned_dataframe.loc[(cleaned_dataframe['y_cm'] < 16) & (cleaned_dataframe['y_cm'] > 13)]
    lane6_df.to_csv("Lane_6_predictions.csv", index=False)


    #Will bin and create csv files based on lanes
    #Leia
elif apparatus_name == "biden":
    ...
    lane1_df = cleaned_dataframe[(cleaned_dataframe['y_cm'] < 2.8)] 
    lane1_df.to_csv("Lane_1_predictions.csv", index=False)

    lane2_df = cleaned_dataframe.loc[(cleaned_dataframe['y_cm'] < 5.4) & (cleaned_dataframe['y_cm'] > 2.8)]
    lane2_df.to_csv("Lane_2_predictions.csv", index=False)

    lane3_df = cleaned_dataframe.loc[(cleaned_dataframe['y_cm'] < 7.8) & (cleaned_dataframe['y_cm'] > 5.4)]
    lane3_df.to_csv("Lane_3_predictions.csv", index=False)

    lane4_df = cleaned_dataframe.loc[(cleaned_dataframe['y_cm'] < 10.4) &(cleaned_dataframe['y_cm'] > 7.8)]
    lane4_df.to_csv("Lane_4_predictions.csv", index=False)

    lane5_df = cleaned_dataframe.loc[(cleaned_dataframe['y_cm'] < 12.8) & (cleaned_dataframe['y_cm'] > 10.4)]
    lane5_df.to_csv("Lane_5_predictions.csv", index=False)

    lane6_df = cleaned_dataframe.loc[(cleaned_dataframe['y_cm'] < 15.5) & (cleaned_dataframe['y_cm'] > 12.8)]
    lane6_df.to_csv("Lane_6_predictions.csv", index=False)
    

else:
    print("You are missing an apparatus!")
    
return lane1_df, lane2_df, lane3_df, lane4_df, lane5_df, lane6_df
